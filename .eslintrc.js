module.exports = {
  ...
  rules: {
    ...
    "no-multi-spaces": 0,  //除了注释，禁止出现多个空格
    ...
    "comma-spacing": ["error", { "before": false, "after": true }], //强制在逗号后面使用空格
    ...
    "react/jsx-filename-extension": [1, { "extensions": [".js", ".jsx", ".tsx"] }], //Restrict file extensions that may contain JSX
